...
An interactive AI chatbot application built using **Streamlit** and **Google Gemini 2.5 Flash**. This project was developed as **Assignment 3** for the **Mirai Virtual Summer Internship 2026 – AI Builder Track**.
